...
Based on the step-by-step analysis, generate a concise executive summary. Format numbers with proper spacing and use consistent formatting. Output only the summary text.
"""